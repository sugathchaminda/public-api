// Se https://docs.oasis-open.org/ubl/UBL-2.1-JSON/v2.0/cnd01/UBL-2.1-JSON-v2.0-cnd01.html#S-UBL-INVOICE-2.1-EXAMPLE-TRIVIAL.JSON for UBL Json examples

const trivialInvoiceUBLJson = (partyLegalEntityCompanyId, invoiceID = '123') => ({
...
const trivialInvoiceUBLJsonWithoutPartyLegalEntity = () => ({
  _D: 'urn:oasis:names:specification:ubl:schema:xsd:Invoice-2',
  _A: 'urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2',
  _B: 'urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2',
  Invoice: [
...
const modifiedInvoiceUBLJson = (partyLegalEntityCompanyId) => ({
  _D: 'urn:oasis:names:specification:ubl:schema:xsd:Invoice-2',
  _A: 'urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2',
  _B: 'urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2',
  Invoice: [
...
const invoiceUBLJson = (partyLegalEntityCompanyId) => ({
  _D: 'urn:oasis:names:specification:ubl:schema:xsd:Invoice-2',
  _A: 'urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2',
  _B: 'urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2',
  Invoice: [
...
module.exports = {
  ...
  trivialInvoiceUBLJsonWithoutPartyLegalEntity,
