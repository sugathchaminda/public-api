const INCOMING_ORDER_RESPONSE_TABLE_NAME = 'incoming_order_response';

exports.up = async (knex) => {
  await knex.raw('CREATE EXTENSION IF NOT EXISTS "uuid-ossp"');
  await knex.schema.createTable(INCOMING_ORDER_RESPONSE_TABLE_NAME, (table) => {
...
exports.down = async (knex) => {
  await knex.schema.dropTable(INCOMING_ORDER_RESPONSE_TABLE_NAME);
};
