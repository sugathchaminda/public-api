const OUTGOING_ORDER_TABLE_NAME = 'outgoing_orders';

exports.up = async (knex) => {
  await knex.raw('CREATE EXTENSION IF NOT EXISTS "uuid-ossp"');
  await knex.schema.createTable(OUTGOING_ORDER_TABLE_NAME, (table) => {
...
exports.down = async (knex) => {
  await knex.schema.dropTable(OUTGOING_ORDER_TABLE_NAME);
};
